...
import { register, login, me, fetchTasks } from "../../services/fetch";
import "./style.scss";
      ...
      <div className="register__container">
        ...
        <div className="register__info">
          ...
          <div className="register__form">
            ...
            >
              <div className="register__inputs">
                ...
                />
                <Validation errorMessage={errors.name} />
                <CustomInput
                  textLabel="E-mail"
                  ...
                  disabled={isPreloaderVisible}
                />
                <Validation errorMessage={errors.email} />
                <CustomInput
                  textLabel="Пароль"
                ...
                />
                <Validation errorMessage={errors.password} />
              </div>
          ...
          <div className="register__footer">
            ...
            <CustomLink className="register__link-blue" linkTo="/signin" textLink="Войти" />
          </div>
        </div>
      </div>
    </section>
